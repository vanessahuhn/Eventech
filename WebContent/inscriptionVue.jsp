...
<%=(session.getAttribute("isConnecte") == null) ? "<a class='nav-link float-right' href='connexionVue.jsp'>Connexion</a>" : "<a class='nav-link float-right' href='LogoutServlet'>Se déconnecter</a>"%>                    
 ...
 <body class="h-100 bg-white">
	<form class="form-signin" name="form" action="InscriptionServlet" method="post" onsubmit="return validate()">
      <div class="text-center mb-4">
        <img class="my-5 img-fluid" src="img/logo.png" alt="">
        <h1 class="mb-3 font-weight-normal">S'inscrire</h1>
      </div>

     
  <div class="form-row mb4">
    <div class="col form-label-group">
      <input type="text" id="firstName" name="prenom" class="form-control" placeholder="Prénom" required>
      <label for="prenom">Prénom</label>

    </div>
    <div class="col form-label-group">
      <input type="text" id="lastName" name="nom" class="form-control" placeholder="Nom" required>
      ...
      <div class="form-label-group mb-4">
        <input type="email" id="inputEmail" name="mail" class="form-control" placeholder="Adresse e-mail" required >
        <label for="mail">Adresse e-mail</label>
      </div>

      <div class="form-label-group mb-4">
        <input type="password" id="inputPassword" name="mot_de_passe" class="form-control" placeholder="Mot de passe" required>
        <label for="mot_de_passe">Mot de passe</label>
      </div>

      <div class="form-group mb-4">
        <input type="password" id="inputPasswordConfirm" class="form-control" data-match="#inputPassword" data-match-error="Le mot de passe ne correspond pas" placeholder="Confirmer mot de passe" required>
      ...
      <div class="d-flex justify-content-center">
      	<button class="btn btn-lg btn-primary mb-4" type="submit">Je m'inscris</button>
    </div>
    <div class="d-flex justify-content-center">
