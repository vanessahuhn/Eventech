...
<div class="container-fluid">
    <main role = "main">
      ...
      <div class="bg-jumbotron jumbotron w-10 ">
          <h1 class="display-3 mt-5 text-center">Vos événements, maintenant !</h1>
          <h5 class="texte1 m-5 text-justify">La buvette tech vous offre la possibilité de créer, gérer et promovoir vos événements, mais aussi de participer à des événements correspondant à vos goûts. La buvette tech vous offre la possibilité de créer, gérer et promovoir vos événements, mais aussi de participer à des événements correspondant à vos goûts.</h5>
          
          <div class="row d-flex justify-content-around">
            <div class="">
          <a class="btn btn-primary btn-lg m-3" href="evenementsVue.jsp" role="button"> Voir un événement &raquo;</a>
      </div>
          <div class="">
          <a class="btn btn-primary btn-lg m-3" href="<%=(session.getAttribute("isConnecte") == null) ? "connexionVue.jsp" : "creerEvenement.jsp"%>" role="button">Créer un événement &raquo;</a>
      </div>
          </div>
      </div>
  </main>
